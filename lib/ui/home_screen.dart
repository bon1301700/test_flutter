...
import 'package:faceclone/ui/camera_screen.dart';
import 'package:faceclone/ui/local_screen.dart';
import 'package:faceclone/widgets/button_widget.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonWidget(
                ...
                onClickListener: () {
                  Navigator.of(context)
                      .push(MaterialPageRoute(builder: (_) => LocalScreen()));
                },
                width: 200,
                color: AppColors.green,
                borderRadius: BorderRadius.circular(15),
